...
- ./scripts/[<b>spCoinSetup.sh</b>](https://github.com/sponsorCoinAdmin/[<b>spCoinUniSwapTests</b>](https://github.com/sponsorCoinAdmin/spCoinUniSwapTests/tree/main)/blob/main/scripts/spCoinSetup.sh)  ~ This file is to be run from the scripts directory and dounloads the [[<b>'spCoinUniSwap'</b>](https://github.com/sponsorCoinAdmin/spCoinUniSwapTests/tree/main)Tests](https://github.com/sponsorCoinAdmin/[<b>'spCoinUniSwapTests'</b>](https://github.com/sponsorCoinAdmin/spCoinUniSwapTests/tree/main) repository to local. Next it executes the [<b>spCoinEnvSetup.sh</b>](https://github.com/sponsorCoinAdmin/spCoinSetupEnv/blob/main/spCoinEnvSetup.sh) file for environment setup.
