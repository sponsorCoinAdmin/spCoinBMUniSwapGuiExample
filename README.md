...
2. Running the test menu display, <b>'tm'</b>, command will list the testing options.
   Running the alias menu command <b>'runserver'</b> will start the [<b>spCoinUniSwap</b>](https://github.com/sponsorCoinAdmin/spCoinUniSwapTests/tree/main) package test.
 - - - -
